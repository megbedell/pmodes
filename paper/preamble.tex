...
\newcommand{\ms}{\ensuremath{\mathrm{m}~\mathrm{s}^{-1}}}
...
\newcommand{\EXPRES}{\project{\acronym{EXPRES}}\xspace}
\newcommand{\ESPRESSO}{\project{\acronym{ESPRESSO}}\xspace}
\newcommand{\KPF}{\project{\acronym{KPF}}\xspace}
